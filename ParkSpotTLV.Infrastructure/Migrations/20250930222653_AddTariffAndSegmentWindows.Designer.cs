...
namespace ParkSpotTLV.Infrastructure.Migrations
{
    ...
    [Migration("20250930222653_AddTariffAndSegmentWindows")]
    partial class AddTariffAndSegmentWindows
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkSpotTLV.Infrastructure.Entities.StreetSegmentRuleWindow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("AppliesToSide")
                        .HasColumnType("integer")
                        .HasColumnName("applies_to_side");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_street_segment_rule_windows");

                    b.HasIndex("StreetSegmentId", "Enabled", "Priority")
                        .HasDatabaseName("ix_street_segment_rule_windows_street_segment_id_enabled_prior");

                    b.ToTable("street_segment_rule_windows", (string)null);
                });

            modelBuilder.Entity("ParkSpotTLV.Infrastructure.Entities.TariffGroupWindow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tariff_group_windows");

                    b.HasIndex("Taarif", "Enabled", "Priority")
                        .HasDatabaseName("ix_tariff_group_windows_taarif_enabled_priority");

                    b.ToTable("tariff_group_windows", (string)null);
                });
            ...
            modelBuilder.Entity("ParkSpotTLV.Infrastructure.Entities.StreetSegmentRuleWindow", b =>
                {
                    b.HasOne("ParkSpotTLV.Infrastructure.Entities.StreetSegment", "StreetSegment")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_street_segment_rule_windows_street_segments_street_segment_");
